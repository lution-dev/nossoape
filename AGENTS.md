...
```powershell
node "c:\Users\Lucas\OneDrive\Documentos\Projetos\lidtek-memoria\hooks\entrada.js" "[describe the task]" "Lumi Imóveis" | Out-File harness\MEMORY_CONTEXT.md -Encoding utf8
```
